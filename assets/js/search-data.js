...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/https://orcid.org/0009-0007-8280-1010", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://arxiv.org/search/?query=jayashree+narayan&searchtype=all&source=header", "_blank");
        },
      },{
      id: 'light-theme',
